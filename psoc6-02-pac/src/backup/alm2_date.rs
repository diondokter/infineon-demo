...
pub type R = crate::R<Alm2DateSpec>;
#[doc = "Register `ALM2_DATE` writer"]
pub type W = crate::W<Alm2DateSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alm_date(&mut self) -> AlmDateW<Alm2DateSpec> {
        AlmDateW::new(self, 0)
    }
    #[doc = "Bit 7 - Alarm Day of the Month enable: 0=ignore, 1=match"]
    #[inline(always)]
    #[must_use]
    pub fn alm_date_en(&mut self) -> AlmDateEnW<Alm2DateSpec> {
        AlmDateEnW::new(self, 7)
    }
    #[doc = "Bits 8:12 - Alarm Month in BCD, 1-12"]
    #[inline(always)]
    #[must_use]
    pub fn alm_mon(&mut self) -> AlmMonW<Alm2DateSpec> {
        AlmMonW::new(self, 8)
    }
    #[doc = "Bit 15 - Alarm Month enable: 0=ignore, 1=match"]
    #[inline(always)]
    #[must_use]
    pub fn alm_mon_en(&mut self) -> AlmMonEnW<Alm2DateSpec> {
        AlmMonEnW::new(self, 15)
    }
    #[doc = "Bit 31 - Master enable for alarm 2. 0: Alarm 2 is disabled. Fields for date and time are ignored. 1: Alarm 2 is enabled. Alarm triggers whenever the new date and time matches all the enabled date and time fields, which can happen more than once depending on configuration. If none of the date and time fields are enabled, then this alarm triggers once every second."]
    #[inline(always)]
    #[must_use]
    pub fn alm_en(&mut self) -> AlmEnW<Alm2DateSpec> {
        AlmEnW::new(self, 31)
    }
}
#[doc = "Alarm 2 Day of Month, Month\n\nYou can [`read`](crate::Reg::read) this register and get [`alm2_date::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`alm2_date::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Alm2DateSpec;
impl crate::RegisterSpec for Alm2DateSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`alm2_date::R`](R) reader structure"]
impl crate::Readable for Alm2DateSpec {}
#[doc = "`write(|w| ..)` method takes [`alm2_date::W`](W) writer structure"]
impl crate::Writable for Alm2DateSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ALM2_DATE to value 0x0101"]
impl crate::Resettable for Alm2DateSpec {
