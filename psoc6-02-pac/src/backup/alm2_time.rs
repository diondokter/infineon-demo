...
pub type R = crate::R<Alm2TimeSpec>;
#[doc = "Register `ALM2_TIME` writer"]
pub type W = crate::W<Alm2TimeSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alm_sec(&mut self) -> AlmSecW<Alm2TimeSpec> {
        AlmSecW::new(self, 0)
    }
    #[doc = "Bit 7 - Alarm second enable: 0=ignore, 1=match"]
    #[inline(always)]
    #[must_use]
    pub fn alm_sec_en(&mut self) -> AlmSecEnW<Alm2TimeSpec> {
        AlmSecEnW::new(self, 7)
    }
    #[doc = "Bits 8:14 - Alarm minutes in BCD, 0-59"]
    #[inline(always)]
    #[must_use]
    pub fn alm_min(&mut self) -> AlmMinW<Alm2TimeSpec> {
        AlmMinW::new(self, 8)
    }
    #[doc = "Bit 15 - Alarm minutes enable: 0=ignore, 1=match"]
    #[inline(always)]
    #[must_use]
    pub fn alm_min_en(&mut self) -> AlmMinEnW<Alm2TimeSpec> {
        AlmMinEnW::new(self, 15)
    }
    #[doc = "Bits 16:21 - Alarm hours in BCD, value depending on 12/24HR mode 12HR: \\[5\\]:0=AM, 1=PM, \\[4:0\\]=1-12 24HR: \\[5:0\\]=0-23"]
    #[inline(always)]
    #[must_use]
    pub fn alm_hour(&mut self) -> AlmHourW<Alm2TimeSpec> {
        AlmHourW::new(self, 16)
    }
    #[doc = "Bit 23 - Alarm hour enable: 0=ignore, 1=match"]
    #[inline(always)]
    #[must_use]
    pub fn alm_hour_en(&mut self) -> AlmHourEnW<Alm2TimeSpec> {
        AlmHourEnW::new(self, 23)
    }
    #[doc = "Bits 24:26 - Alarm Day of the week in BCD, 1-7 It is up to the user to define the meaning of the values, but 1=Monday is recommended"]
    #[inline(always)]
    #[must_use]
    pub fn alm_day(&mut self) -> AlmDayW<Alm2TimeSpec> {
        AlmDayW::new(self, 24)
    }
    #[doc = "Bit 31 - Alarm Day of the Week enable: 0=ignore, 1=match"]
    #[inline(always)]
    #[must_use]
    pub fn alm_day_en(&mut self) -> AlmDayEnW<Alm2TimeSpec> {
        AlmDayEnW::new(self, 31)
    }
}
#[doc = "Alarm 2 Seconds, Minute, Hours, Day of Week\n\nYou can [`read`](crate::Reg::read) this register and get [`alm2_time::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`alm2_time::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Alm2TimeSpec;
impl crate::RegisterSpec for Alm2TimeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`alm2_time::R`](R) reader structure"]
impl crate::Readable for Alm2TimeSpec {}
#[doc = "`write(|w| ..)` method takes [`alm2_time::W`](W) writer structure"]
impl crate::Writable for Alm2TimeSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ALM2_TIME to value 0x0100_0000"]
impl crate::Resettable for Alm2TimeSpec {
