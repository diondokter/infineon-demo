...
pub type R = crate::R<Cm0Int1StatusSpec>;
...
#[doc = "CM0+ interrupt 1 status\n\nYou can [`read`](crate::Reg::read) this register and get [`cm0_int1_status::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cm0Int1StatusSpec;
impl crate::RegisterSpec for Cm0Int1StatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cm0_int1_status::R`](R) reader structure"]
impl crate::Readable for Cm0Int1StatusSpec {}
#[doc = "`reset()` method sets CM0_INT1_STATUS to value 0"]
impl crate::Resettable for Cm0Int1StatusSpec {
