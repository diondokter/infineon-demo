...
pub type R = crate::R<Cm4Int5StatusSpec>;
...
#[doc = "CM4 interrupt 5 status\n\nYou can [`read`](crate::Reg::read) this register and get [`cm4_int5_status::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cm4Int5StatusSpec;
impl crate::RegisterSpec for Cm4Int5StatusSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cm4_int5_status::R`](R) reader structure"]
impl crate::Readable for Cm4Int5StatusSpec {}
#[doc = "`reset()` method sets CM4_INT5_STATUS to value 0"]
impl crate::Resettable for Cm4Int5StatusSpec {
