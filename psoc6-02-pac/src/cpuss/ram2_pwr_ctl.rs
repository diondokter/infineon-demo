...
pub type R = crate::R<Ram2PwrCtlSpec>;
#[doc = "Register `RAM2_PWR_CTL` writer"]
pub type W = crate::W<Ram2PwrCtlSpec>;
#[doc = "Power mode.\n\nValue on reset: 3"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwr_mode(&mut self) -> PwrModeW<Ram2PwrCtlSpec> {
        PwrModeW::new(self, 0)
    }
}
#[doc = "RAM 2 power control\n\nYou can [`read`](crate::Reg::read) this register and get [`ram2_pwr_ctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ram2_pwr_ctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ram2PwrCtlSpec;
impl crate::RegisterSpec for Ram2PwrCtlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ram2_pwr_ctl::R`](R) reader structure"]
impl crate::Readable for Ram2PwrCtlSpec {}
#[doc = "`write(|w| ..)` method takes [`ram2_pwr_ctl::W`](W) writer structure"]
impl crate::Writable for Ram2PwrCtlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RAM2_PWR_CTL to value 0xfa05_0003"]
impl crate::Resettable for Ram2PwrCtlSpec {
