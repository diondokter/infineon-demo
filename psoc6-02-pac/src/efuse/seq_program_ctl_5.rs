...
pub type R = crate::R<SeqProgramCtl5Spec>;
#[doc = "Register `SEQ_PROGRAM_CTL_5` writer"]
pub type W = crate::W<SeqProgramCtl5Spec>;
...
IP clock cycles."]
    #[inline(always)]
    #[must_use]
    pub fn cycles(&mut self) -> CyclesW<SeqProgramCtl5Spec> {
        CyclesW::new(self, 0)
    }
    #[doc = "Bit 16 - Specifies value of eFUSE control signal strobe_a"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_a(&mut self) -> StrobeAW<SeqProgramCtl5Spec> {
        StrobeAW::new(self, 16)
    }
    #[doc = "Bit 17 - Specifies value of eFUSEcontrol signal strobe_b"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_b(&mut self) -> StrobeBW<SeqProgramCtl5Spec> {
        StrobeBW::new(self, 17)
    }
    #[doc = "Bit 18 - Specifies value of eFUSE control signal strobe_c"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_c(&mut self) -> StrobeCW<SeqProgramCtl5Spec> {
        StrobeCW::new(self, 18)
    }
    #[doc = "Bit 19 - Specifies value of eFUSE control signal strobe_d"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_d(&mut self) -> StrobeDW<SeqProgramCtl5Spec> {
        StrobeDW::new(self, 19)
    }
    #[doc = "Bit 20 - Specifies value of eFUSE control signal strobe_e"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_e(&mut self) -> StrobeEW<SeqProgramCtl5Spec> {
        StrobeEW::new(self, 20)
    }
    #[doc = "Bit 21 - Specifies value of eFUSE control signal strobe_f"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_f(&mut self) -> StrobeFW<SeqProgramCtl5Spec> {
        StrobeFW::new(self, 21)
    }
    #[doc = "Bit 22 - Specifies value of eFUSE control signal strobe_g"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_g(&mut self) -> StrobeGW<SeqProgramCtl5Spec> {
        StrobeGW::new(self, 22)
    }
    #[doc = "Bit 31 - When set to 1 indicates that the Read cycle ends when the current cycle count reaches 0."]
    #[inline(always)]
    #[must_use]
    pub fn done(&mut self) -> DoneW<SeqProgramCtl5Spec> {
        DoneW::new(self, 31)
    }
}
#[doc = "Sequencer program control 5\n\nYou can [`read`](crate::Reg::read) this register and get [`seq_program_ctl_5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`seq_program_ctl_5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SeqProgramCtl5Spec;
impl crate::RegisterSpec for SeqProgramCtl5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`seq_program_ctl_5::R`](R) reader structure"]
impl crate::Readable for SeqProgramCtl5Spec {}
#[doc = "`write(|w| ..)` method takes [`seq_program_ctl_5::W`](W) writer structure"]
impl crate::Writable for SeqProgramCtl5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SEQ_PROGRAM_CTL_5 to value 0x803d_0019"]
impl crate::Resettable for SeqProgramCtl5Spec {
    const RESET_VALUE: u32 = 0x803d_0019;
}
