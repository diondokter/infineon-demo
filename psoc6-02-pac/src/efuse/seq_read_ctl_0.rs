...
pub type R = crate::R<SeqReadCtl0Spec>;
#[doc = "Register `SEQ_READ_CTL_0` writer"]
pub type W = crate::W<SeqReadCtl0Spec>;
...
IP clock cycles."]
    #[inline(always)]
    #[must_use]
    pub fn cycles(&mut self) -> CyclesW<SeqReadCtl0Spec> {
        CyclesW::new(self, 0)
    }
    #[doc = "Bit 16 - Specifies value of eFUSE control signal strobe_f"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_a(&mut self) -> StrobeAW<SeqReadCtl0Spec> {
        StrobeAW::new(self, 16)
    }
    #[doc = "Bit 17 - Specifies value of eFUSEcontrol signal strobe_b"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_b(&mut self) -> StrobeBW<SeqReadCtl0Spec> {
        StrobeBW::new(self, 17)
    }
    #[doc = "Bit 18 - Specifies value of eFUSE control signal strobe_c"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_c(&mut self) -> StrobeCW<SeqReadCtl0Spec> {
        StrobeCW::new(self, 18)
    }
    #[doc = "Bit 19 - Specifies value of eFUSE control signal strobe_d"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_d(&mut self) -> StrobeDW<SeqReadCtl0Spec> {
        StrobeDW::new(self, 19)
    }
    #[doc = "Bit 20 - Specifies value of eFUSE control signal strobe_e"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_e(&mut self) -> StrobeEW<SeqReadCtl0Spec> {
        StrobeEW::new(self, 20)
    }
    #[doc = "Bit 21 - Specifies value of eFUSE control signal strobe_f"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_f(&mut self) -> StrobeFW<SeqReadCtl0Spec> {
        StrobeFW::new(self, 21)
    }
    #[doc = "Bit 22 - Specifies value of eFUSE control signal strobe_g"]
    #[inline(always)]
    #[must_use]
    pub fn strobe_g(&mut self) -> StrobeGW<SeqReadCtl0Spec> {
        StrobeGW::new(self, 22)
    }
    #[doc = "Bit 31 - When set to 1 indicates that the Read cycle ends when the current cycle count reaches 0."]
    #[inline(always)]
    #[must_use]
    pub fn done(&mut self) -> DoneW<SeqReadCtl0Spec> {
        DoneW::new(self, 31)
    }
}
#[doc = "Sequencer read control 0\n\nYou can [`read`](crate::Reg::read) this register and get [`seq_read_ctl_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`seq_read_ctl_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SeqReadCtl0Spec;
impl crate::RegisterSpec for SeqReadCtl0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`seq_read_ctl_0::R`](R) reader structure"]
impl crate::Readable for SeqReadCtl0Spec {}
#[doc = "`write(|w| ..)` method takes [`seq_read_ctl_0::W`](W) writer structure"]
impl crate::Writable for SeqReadCtl0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SEQ_READ_CTL_0 to value 0x8056_0001"]
impl crate::Resettable for SeqReadCtl0Spec {
    const RESET_VALUE: u32 = 0x8056_0001;
}
