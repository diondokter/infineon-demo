...
pub type R = crate::R<Cm4CaCtl2Spec>;
#[doc = "Register `CM4_CA_CTL2` writer"]
pub type W = crate::W<Cm4CaCtl2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwrup_delay(&mut self) -> PwrupDelayW<Cm4CaCtl2Spec> {
        PwrupDelayW::new(self, 0)
    }
}
#[doc = "CM4 cache control\n\nYou can [`read`](crate::Reg::read) this register and get [`cm4_ca_ctl2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cm4_ca_ctl2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cm4CaCtl2Spec;
impl crate::RegisterSpec for Cm4CaCtl2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cm4_ca_ctl2::R`](R) reader structure"]
impl crate::Readable for Cm4CaCtl2Spec {}
#[doc = "`write(|w| ..)` method takes [`cm4_ca_ctl2::W`](W) writer structure"]
impl crate::Writable for Cm4CaCtl2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CM4_CA_CTL2 to value 0x012c"]
impl crate::Resettable for Cm4CaCtl2Spec {
