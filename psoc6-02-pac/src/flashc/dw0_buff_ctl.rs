...
pub type R = crate::R<Dw0BuffCtlSpec>;
#[doc = "Register `DW0_BUFF_CTL` writer"]
pub type W = crate::W<Dw0BuffCtlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pref_en(&mut self) -> PrefEnW<Dw0BuffCtlSpec> {
        PrefEnW::new(self, 30)
    }
}
#[doc = "Datawire 0 buffer control\n\nYou can [`read`](crate::Reg::read) this register and get [`dw0_buff_ctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dw0_buff_ctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Dw0BuffCtlSpec;
impl crate::RegisterSpec for Dw0BuffCtlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dw0_buff_ctl::R`](R) reader structure"]
impl crate::Readable for Dw0BuffCtlSpec {}
#[doc = "`write(|w| ..)` method takes [`dw0_buff_ctl::W`](W) writer structure"]
impl crate::Writable for Dw0BuffCtlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DW0_BUFF_CTL to value 0x4000_0000"]
impl crate::Resettable for Dw0BuffCtlSpec {
