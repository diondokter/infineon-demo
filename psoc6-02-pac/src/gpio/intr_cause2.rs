...
pub type R = crate::R<IntrCause2Spec>;
...
#[doc = "Interrupt port cause register 2\n\nYou can [`read`](crate::Reg::read) this register and get [`intr_cause2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IntrCause2Spec;
impl crate::RegisterSpec for IntrCause2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intr_cause2::R`](R) reader structure"]
impl crate::Readable for IntrCause2Spec {}
#[doc = "`reset()` method sets INTR_CAUSE2 to value 0"]
impl crate::Resettable for IntrCause2Spec {
