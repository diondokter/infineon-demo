...
pub type TxReqEnR = crate::BitReader;
...
pub type TxReqEnW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn tx_req_en(&self) -> TxReqEnR {
        TxReqEnR::new((self.bits & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tx_req_en(&mut self) -> TxReqEnW<TrCtlSpec> {
        TxReqEnW::new(self, 0)
    }
    #[doc = "Bit 16 - Trigger output ('tr_i2s_rx_req') enable for requests of DMA transfer in reception '0': Disabled. '1': Enabled."]
    #[inline(always)]
