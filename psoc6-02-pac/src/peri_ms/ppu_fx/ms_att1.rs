...
pub type R = crate::R<MsAtt1Spec>;
#[doc = "Register `MS_ATT1` writer"]
pub type W = crate::W<MsAtt1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc4_uw(&mut self) -> Pc4UwW<MsAtt1Spec> {
        Pc4UwW::new(self, 1)
    }
    #[doc = "Bit 3 - Protection context 4, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc4_pw(&mut self) -> Pc4PwW<MsAtt1Spec> {
        Pc4PwW::new(self, 3)
    }
    #[doc = "Bit 4 - Protection context 4, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc4_ns(&mut self) -> Pc4NsW<MsAtt1Spec> {
        Pc4NsW::new(self, 4)
    }
    #[doc = "Bit 9 - Protection context 5, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc5_uw(&mut self) -> Pc5UwW<MsAtt1Spec> {
        Pc5UwW::new(self, 9)
    }
    #[doc = "Bit 11 - Protection context 5, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc5_pw(&mut self) -> Pc5PwW<MsAtt1Spec> {
        Pc5PwW::new(self, 11)
    }
    #[doc = "Bit 12 - Protection context 5, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc5_ns(&mut self) -> Pc5NsW<MsAtt1Spec> {
        Pc5NsW::new(self, 12)
    }
    #[doc = "Bit 17 - Protection context 6, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc6_uw(&mut self) -> Pc6UwW<MsAtt1Spec> {
        Pc6UwW::new(self, 17)
    }
    #[doc = "Bit 19 - Protection context 6, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc6_pw(&mut self) -> Pc6PwW<MsAtt1Spec> {
        Pc6PwW::new(self, 19)
    }
    #[doc = "Bit 20 - Protection context 6, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc6_ns(&mut self) -> Pc6NsW<MsAtt1Spec> {
        Pc6NsW::new(self, 20)
    }
    #[doc = "Bit 25 - Protection context 7, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc7_uw(&mut self) -> Pc7UwW<MsAtt1Spec> {
        Pc7UwW::new(self, 25)
    }
    #[doc = "Bit 27 - Protection context 7, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc7_pw(&mut self) -> Pc7PwW<MsAtt1Spec> {
        Pc7PwW::new(self, 27)
    }
    #[doc = "Bit 28 - Protection context 7, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc7_ns(&mut self) -> Pc7NsW<MsAtt1Spec> {
        Pc7NsW::new(self, 28)
    }
}
#[doc = "Master attributes 1\n\nYou can [`read`](crate::Reg::read) this register and get [`ms_att1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ms_att1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MsAtt1Spec;
impl crate::RegisterSpec for MsAtt1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ms_att1::R`](R) reader structure"]
impl crate::Readable for MsAtt1Spec {}
#[doc = "`write(|w| ..)` method takes [`ms_att1::W`](W) writer structure"]
impl crate::Writable for MsAtt1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MS_ATT1 to value 0x1f1f_1f1f"]
impl crate::Resettable for MsAtt1Spec {
