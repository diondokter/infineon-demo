...
pub type R = crate::R<MsAtt2Spec>;
#[doc = "Register `MS_ATT2` writer"]
pub type W = crate::W<MsAtt2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc8_uw(&mut self) -> Pc8UwW<MsAtt2Spec> {
        Pc8UwW::new(self, 1)
    }
    #[doc = "Bit 3 - Protection context 8, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc8_pw(&mut self) -> Pc8PwW<MsAtt2Spec> {
        Pc8PwW::new(self, 3)
    }
    #[doc = "Bit 4 - Protection context 8, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc8_ns(&mut self) -> Pc8NsW<MsAtt2Spec> {
        Pc8NsW::new(self, 4)
    }
    #[doc = "Bit 9 - Protection context 9, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc9_uw(&mut self) -> Pc9UwW<MsAtt2Spec> {
        Pc9UwW::new(self, 9)
    }
    #[doc = "Bit 11 - Protection context 9, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc9_pw(&mut self) -> Pc9PwW<MsAtt2Spec> {
        Pc9PwW::new(self, 11)
    }
    #[doc = "Bit 12 - Protection context 9, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc9_ns(&mut self) -> Pc9NsW<MsAtt2Spec> {
        Pc9NsW::new(self, 12)
    }
    #[doc = "Bit 17 - Protection context 10, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc10_uw(&mut self) -> Pc10UwW<MsAtt2Spec> {
        Pc10UwW::new(self, 17)
    }
    #[doc = "Bit 19 - Protection context 10, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc10_pw(&mut self) -> Pc10PwW<MsAtt2Spec> {
        Pc10PwW::new(self, 19)
    }
    #[doc = "Bit 20 - Protection context 10, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc10_ns(&mut self) -> Pc10NsW<MsAtt2Spec> {
        Pc10NsW::new(self, 20)
    }
    #[doc = "Bit 25 - Protection context 11, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc11_uw(&mut self) -> Pc11UwW<MsAtt2Spec> {
        Pc11UwW::new(self, 25)
    }
    #[doc = "Bit 27 - Protection context 11, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc11_pw(&mut self) -> Pc11PwW<MsAtt2Spec> {
        Pc11PwW::new(self, 27)
    }
    #[doc = "Bit 28 - Protection context 11, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc11_ns(&mut self) -> Pc11NsW<MsAtt2Spec> {
        Pc11NsW::new(self, 28)
    }
}
#[doc = "Master attributes 2\n\nYou can [`read`](crate::Reg::read) this register and get [`ms_att2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ms_att2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MsAtt2Spec;
impl crate::RegisterSpec for MsAtt2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ms_att2::R`](R) reader structure"]
impl crate::Readable for MsAtt2Spec {}
#[doc = "`write(|w| ..)` method takes [`ms_att2::W`](W) writer structure"]
impl crate::Writable for MsAtt2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MS_ATT2 to value 0x1f1f_1f1f"]
impl crate::Resettable for MsAtt2Spec {
