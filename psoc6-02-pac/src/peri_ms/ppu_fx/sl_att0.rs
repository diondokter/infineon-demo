...
pub type R = crate::R<SlAtt0Spec>;
#[doc = "Register `SL_ATT0` writer"]
pub type W = crate::W<SlAtt0Spec>;
...
pub type Pc1UrW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Pc1PrW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Pc2UrW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Pc2PrW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Pc3UrW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Pc3PrW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc1_ur(&mut self) -> Pc1UrW<SlAtt0Spec> {
        Pc1UrW::new(self, 8)
    }
    #[doc = "Bit 9 - Protection context 1, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc1_uw(&mut self) -> Pc1UwW<SlAtt0Spec> {
        Pc1UwW::new(self, 9)
    }
    #[doc = "Bit 10 - Protection context 1, privileged read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc1_pr(&mut self) -> Pc1PrW<SlAtt0Spec> {
        Pc1PrW::new(self, 10)
    }
    #[doc = "Bit 11 - Protection context 1, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc1_pw(&mut self) -> Pc1PwW<SlAtt0Spec> {
        Pc1PwW::new(self, 11)
    }
    #[doc = "Bit 12 - Protection context 1, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc1_ns(&mut self) -> Pc1NsW<SlAtt0Spec> {
        Pc1NsW::new(self, 12)
    }
    #[doc = "Bit 16 - Protection context 2, user read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc2_ur(&mut self) -> Pc2UrW<SlAtt0Spec> {
        Pc2UrW::new(self, 16)
    }
    #[doc = "Bit 17 - Protection context 2, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc2_uw(&mut self) -> Pc2UwW<SlAtt0Spec> {
        Pc2UwW::new(self, 17)
    }
    #[doc = "Bit 18 - Protection context 2, privileged read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc2_pr(&mut self) -> Pc2PrW<SlAtt0Spec> {
        Pc2PrW::new(self, 18)
    }
    #[doc = "Bit 19 - Protection context 2, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc2_pw(&mut self) -> Pc2PwW<SlAtt0Spec> {
        Pc2PwW::new(self, 19)
    }
    #[doc = "Bit 20 - Protection context 2, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc2_ns(&mut self) -> Pc2NsW<SlAtt0Spec> {
        Pc2NsW::new(self, 20)
    }
    #[doc = "Bit 24 - Protection context 3, user read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc3_ur(&mut self) -> Pc3UrW<SlAtt0Spec> {
        Pc3UrW::new(self, 24)
    }
    #[doc = "Bit 25 - Protection context 3, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc3_uw(&mut self) -> Pc3UwW<SlAtt0Spec> {
        Pc3UwW::new(self, 25)
    }
    #[doc = "Bit 26 - Protection context 3, privileged read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc3_pr(&mut self) -> Pc3PrW<SlAtt0Spec> {
        Pc3PrW::new(self, 26)
    }
    #[doc = "Bit 27 - Protection context 3, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc3_pw(&mut self) -> Pc3PwW<SlAtt0Spec> {
        Pc3PwW::new(self, 27)
    }
    #[doc = "Bit 28 - Protection context 3, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc3_ns(&mut self) -> Pc3NsW<SlAtt0Spec> {
        Pc3NsW::new(self, 28)
    }
}
#[doc = "Slave attributes 0\n\nYou can [`read`](crate::Reg::read) this register and get [`sl_att0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sl_att0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SlAtt0Spec;
impl crate::RegisterSpec for SlAtt0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sl_att0::R`](R) reader structure"]
impl crate::Readable for SlAtt0Spec {}
#[doc = "`write(|w| ..)` method takes [`sl_att0::W`](W) writer structure"]
impl crate::Writable for SlAtt0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SL_ATT0 to value 0x1f1f_1f1f"]
impl crate::Resettable for SlAtt0Spec {
