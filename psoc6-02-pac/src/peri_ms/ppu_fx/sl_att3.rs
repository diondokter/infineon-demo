...
pub type R = crate::R<SlAtt3Spec>;
#[doc = "Register `SL_ATT3` writer"]
pub type W = crate::W<SlAtt3Spec>;
...
pub type Pc12UrW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Pc12PrW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Pc13UrW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Pc13PrW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Pc14UrW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Pc14PrW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Pc15UrW<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Pc15PrW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc12_ur(&mut self) -> Pc12UrW<SlAtt3Spec> {
        Pc12UrW::new(self, 0)
    }
    #[doc = "Bit 1 - Protection context 12, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc12_uw(&mut self) -> Pc12UwW<SlAtt3Spec> {
        Pc12UwW::new(self, 1)
    }
    #[doc = "Bit 2 - Protection context 12, privileged read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc12_pr(&mut self) -> Pc12PrW<SlAtt3Spec> {
        Pc12PrW::new(self, 2)
    }
    #[doc = "Bit 3 - Protection context 12, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc12_pw(&mut self) -> Pc12PwW<SlAtt3Spec> {
        Pc12PwW::new(self, 3)
    }
    #[doc = "Bit 4 - Protection context 12, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc12_ns(&mut self) -> Pc12NsW<SlAtt3Spec> {
        Pc12NsW::new(self, 4)
    }
    #[doc = "Bit 8 - Protection context 13, user read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc13_ur(&mut self) -> Pc13UrW<SlAtt3Spec> {
        Pc13UrW::new(self, 8)
    }
    #[doc = "Bit 9 - Protection context 13, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc13_uw(&mut self) -> Pc13UwW<SlAtt3Spec> {
        Pc13UwW::new(self, 9)
    }
    #[doc = "Bit 10 - Protection context 13, privileged read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc13_pr(&mut self) -> Pc13PrW<SlAtt3Spec> {
        Pc13PrW::new(self, 10)
    }
    #[doc = "Bit 11 - Protection context 13, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc13_pw(&mut self) -> Pc13PwW<SlAtt3Spec> {
        Pc13PwW::new(self, 11)
    }
    #[doc = "Bit 12 - Protection context 13, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc13_ns(&mut self) -> Pc13NsW<SlAtt3Spec> {
        Pc13NsW::new(self, 12)
    }
    #[doc = "Bit 16 - Protection context 14, user read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc14_ur(&mut self) -> Pc14UrW<SlAtt3Spec> {
        Pc14UrW::new(self, 16)
    }
    #[doc = "Bit 17 - Protection context 14, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc14_uw(&mut self) -> Pc14UwW<SlAtt3Spec> {
        Pc14UwW::new(self, 17)
    }
    #[doc = "Bit 18 - Protection context 14, privileged read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc14_pr(&mut self) -> Pc14PrW<SlAtt3Spec> {
        Pc14PrW::new(self, 18)
    }
    #[doc = "Bit 19 - Protection context 14, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc14_pw(&mut self) -> Pc14PwW<SlAtt3Spec> {
        Pc14PwW::new(self, 19)
    }
    #[doc = "Bit 20 - Protection context 14, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc14_ns(&mut self) -> Pc14NsW<SlAtt3Spec> {
        Pc14NsW::new(self, 20)
    }
    #[doc = "Bit 24 - Protection context 15, user read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc15_ur(&mut self) -> Pc15UrW<SlAtt3Spec> {
        Pc15UrW::new(self, 24)
    }
    #[doc = "Bit 25 - Protection context 15, user write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc15_uw(&mut self) -> Pc15UwW<SlAtt3Spec> {
        Pc15UwW::new(self, 25)
    }
    #[doc = "Bit 26 - Protection context 15, privileged read enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc15_pr(&mut self) -> Pc15PrW<SlAtt3Spec> {
        Pc15PrW::new(self, 26)
    }
    #[doc = "Bit 27 - Protection context 15, privileged write enable."]
    #[inline(always)]
    #[must_use]
    pub fn pc15_pw(&mut self) -> Pc15PwW<SlAtt3Spec> {
        Pc15PwW::new(self, 27)
    }
    #[doc = "Bit 28 - Protection context 15, non-secure."]
    #[inline(always)]
    #[must_use]
    pub fn pc15_ns(&mut self) -> Pc15NsW<SlAtt3Spec> {
        Pc15NsW::new(self, 28)
    }
}
#[doc = "Slave attributes 3\n\nYou can [`read`](crate::Reg::read) this register and get [`sl_att3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sl_att3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SlAtt3Spec;
impl crate::RegisterSpec for SlAtt3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sl_att3::R`](R) reader structure"]
impl crate::Readable for SlAtt3Spec {}
#[doc = "`write(|w| ..)` method takes [`sl_att3::W`](W) writer structure"]
impl crate::Writable for SlAtt3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SL_ATT3 to value 0x1f1f_1f1f"]
impl crate::Resettable for SlAtt3Spec {
