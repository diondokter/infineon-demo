...
#[doc = "SL_ADDR (rw) register accessor: Slave region, base address\n\nYou can [`read`](crate::Reg::read) this register and get [`sl_addr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sl_addr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sl_addr`]
module"]
#[doc(alias = "SL_ADDR")]
pub type SlAddr = crate::Reg<sl_addr::SlAddrSpec>;
#[doc = "Slave region, base address"]
pub mod sl_addr;
#[doc = "SL_SIZE (rw) register accessor: Slave region, size\n\nYou can [`read`](crate::Reg::read) this register and get [`sl_size::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sl_size::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sl_size`]
module"]
#[doc(alias = "SL_SIZE")]
