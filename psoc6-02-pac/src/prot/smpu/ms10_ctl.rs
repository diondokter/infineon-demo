...
pub type R = crate::R<Ms10CtlSpec>;
#[doc = "Register `MS10_CTL` writer"]
pub type W = crate::W<Ms10CtlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p(&mut self) -> PW<Ms10CtlSpec> {
        PW::new(self, 0)
    }
    #[doc = "Bit 1 - See MS0_CTL.NS."]
    #[inline(always)]
    #[must_use]
    pub fn ns(&mut self) -> NsW<Ms10CtlSpec> {
        NsW::new(self, 1)
    }
    #[doc = "Bits 8:9 - See MS0_CTL.PRIO"]
    #[inline(always)]
    #[must_use]
    pub fn prio(&mut self) -> PrioW<Ms10CtlSpec> {
        PrioW::new(self, 8)
    }
    #[doc = "Bits 17:31 - See MS0_CTL.PC_MASK_15_TO_1."]
    #[inline(always)]
    #[must_use]
    pub fn pc_mask_15_to_1(&mut self) -> PcMask15To1W<Ms10CtlSpec> {
        PcMask15To1W::new(self, 17)
    }
}
#[doc = "Master 10 protection context control\n\nYou can [`read`](crate::Reg::read) this register and get [`ms10_ctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ms10_ctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ms10CtlSpec;
impl crate::RegisterSpec for Ms10CtlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ms10_ctl::R`](R) reader structure"]
impl crate::Readable for Ms10CtlSpec {}
#[doc = "`write(|w| ..)` method takes [`ms10_ctl::W`](W) writer structure"]
impl crate::Writable for Ms10CtlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MS10_CTL to value 0x0303"]
impl crate::Resettable for Ms10CtlSpec {
