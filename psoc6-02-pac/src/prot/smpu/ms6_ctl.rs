...
pub type R = crate::R<Ms6CtlSpec>;
#[doc = "Register `MS6_CTL` writer"]
pub type W = crate::W<Ms6CtlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p(&mut self) -> PW<Ms6CtlSpec> {
        PW::new(self, 0)
    }
    #[doc = "Bit 1 - See MS0_CTL.NS."]
    #[inline(always)]
    #[must_use]
    pub fn ns(&mut self) -> NsW<Ms6CtlSpec> {
        NsW::new(self, 1)
    }
    #[doc = "Bits 8:9 - See MS0_CTL.PRIO"]
    #[inline(always)]
    #[must_use]
    pub fn prio(&mut self) -> PrioW<Ms6CtlSpec> {
        PrioW::new(self, 8)
    }
    #[doc = "Bits 17:31 - See MS0_CTL.PC_MASK_15_TO_1."]
    #[inline(always)]
    #[must_use]
    pub fn pc_mask_15_to_1(&mut self) -> PcMask15To1W<Ms6CtlSpec> {
        PcMask15To1W::new(self, 17)
    }
}
#[doc = "Master 6 protection context control\n\nYou can [`read`](crate::Reg::read) this register and get [`ms6_ctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ms6_ctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ms6CtlSpec;
impl crate::RegisterSpec for Ms6CtlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ms6_ctl::R`](R) reader structure"]
impl crate::Readable for Ms6CtlSpec {}
#[doc = "`write(|w| ..)` method takes [`ms6_ctl::W`](W) writer structure"]
impl crate::Writable for Ms6CtlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MS6_CTL to value 0x0303"]
impl crate::Resettable for Ms6CtlSpec {
