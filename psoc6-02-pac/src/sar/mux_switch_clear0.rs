...
pub type R = crate::R<MuxSwitchClear0Spec>;
#[doc = "Register `MUX_SWITCH_CLEAR0` writer"]
pub type W = crate::W<MuxSwitchClear0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p0_vplus(&mut self) -> MuxFwP0VplusW<MuxSwitchClear0Spec> {
        MuxFwP0VplusW::new(self, 0)
    }
    #[doc = "Bit 1 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p1_vplus(&mut self) -> MuxFwP1VplusW<MuxSwitchClear0Spec> {
        MuxFwP1VplusW::new(self, 1)
    }
    #[doc = "Bit 2 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p2_vplus(&mut self) -> MuxFwP2VplusW<MuxSwitchClear0Spec> {
        MuxFwP2VplusW::new(self, 2)
    }
    #[doc = "Bit 3 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p3_vplus(&mut self) -> MuxFwP3VplusW<MuxSwitchClear0Spec> {
        MuxFwP3VplusW::new(self, 3)
    }
    #[doc = "Bit 4 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p4_vplus(&mut self) -> MuxFwP4VplusW<MuxSwitchClear0Spec> {
        MuxFwP4VplusW::new(self, 4)
    }
    #[doc = "Bit 5 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p5_vplus(&mut self) -> MuxFwP5VplusW<MuxSwitchClear0Spec> {
        MuxFwP5VplusW::new(self, 5)
    }
    #[doc = "Bit 6 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p6_vplus(&mut self) -> MuxFwP6VplusW<MuxSwitchClear0Spec> {
        MuxFwP6VplusW::new(self, 6)
    }
    #[doc = "Bit 7 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p7_vplus(&mut self) -> MuxFwP7VplusW<MuxSwitchClear0Spec> {
        MuxFwP7VplusW::new(self, 7)
    }
    #[doc = "Bit 8 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p0_vminus(&mut self) -> MuxFwP0VminusW<MuxSwitchClear0Spec> {
        MuxFwP0VminusW::new(self, 8)
    }
    #[doc = "Bit 9 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p1_vminus(&mut self) -> MuxFwP1VminusW<MuxSwitchClear0Spec> {
        MuxFwP1VminusW::new(self, 9)
    }
    #[doc = "Bit 10 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p2_vminus(&mut self) -> MuxFwP2VminusW<MuxSwitchClear0Spec> {
        MuxFwP2VminusW::new(self, 10)
    }
    #[doc = "Bit 11 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p3_vminus(&mut self) -> MuxFwP3VminusW<MuxSwitchClear0Spec> {
        MuxFwP3VminusW::new(self, 11)
    }
    #[doc = "Bit 12 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p4_vminus(&mut self) -> MuxFwP4VminusW<MuxSwitchClear0Spec> {
        MuxFwP4VminusW::new(self, 12)
    }
    #[doc = "Bit 13 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p5_vminus(&mut self) -> MuxFwP5VminusW<MuxSwitchClear0Spec> {
        MuxFwP5VminusW::new(self, 13)
    }
    #[doc = "Bit 14 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p6_vminus(&mut self) -> MuxFwP6VminusW<MuxSwitchClear0Spec> {
        MuxFwP6VminusW::new(self, 14)
    }
    #[doc = "Bit 15 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p7_vminus(&mut self) -> MuxFwP7VminusW<MuxSwitchClear0Spec> {
        MuxFwP7VminusW::new(self, 15)
    }
    #[doc = "Bit 16 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_vssa_vminus(&mut self) -> MuxFwVssaVminusW<MuxSwitchClear0Spec> {
        MuxFwVssaVminusW::new(self, 16)
    }
    #[doc = "Bit 17 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_temp_vplus(&mut self) -> MuxFwTempVplusW<MuxSwitchClear0Spec> {
        MuxFwTempVplusW::new(self, 17)
    }
    #[doc = "Bit 18 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_amuxbusa_vplus(&mut self) -> MuxFwAmuxbusaVplusW<MuxSwitchClear0Spec> {
        MuxFwAmuxbusaVplusW::new(self, 18)
    }
    #[doc = "Bit 19 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_amuxbusb_vplus(&mut self) -> MuxFwAmuxbusbVplusW<MuxSwitchClear0Spec> {
        MuxFwAmuxbusbVplusW::new(self, 19)
    }
    #[doc = "Bit 20 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_amuxbusa_vminus(&mut self) -> MuxFwAmuxbusaVminusW<MuxSwitchClear0Spec> {
        MuxFwAmuxbusaVminusW::new(self, 20)
    }
    #[doc = "Bit 21 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_amuxbusb_vminus(&mut self) -> MuxFwAmuxbusbVminusW<MuxSwitchClear0Spec> {
        MuxFwAmuxbusbVminusW::new(self, 21)
    }
    #[doc = "Bit 22 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_sarbus0_vplus(&mut self) -> MuxFwSarbus0VplusW<MuxSwitchClear0Spec> {
        MuxFwSarbus0VplusW::new(self, 22)
    }
    #[doc = "Bit 23 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_sarbus1_vplus(&mut self) -> MuxFwSarbus1VplusW<MuxSwitchClear0Spec> {
        MuxFwSarbus1VplusW::new(self, 23)
    }
    #[doc = "Bit 24 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_sarbus0_vminus(&mut self) -> MuxFwSarbus0VminusW<MuxSwitchClear0Spec> {
        MuxFwSarbus0VminusW::new(self, 24)
    }
    #[doc = "Bit 25 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_sarbus1_vminus(&mut self) -> MuxFwSarbus1VminusW<MuxSwitchClear0Spec> {
        MuxFwSarbus1VminusW::new(self, 25)
    }
    #[doc = "Bit 26 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p4_coreio0(&mut self) -> MuxFwP4Coreio0W<MuxSwitchClear0Spec> {
        MuxFwP4Coreio0W::new(self, 26)
    }
    #[doc = "Bit 27 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p5_coreio1(&mut self) -> MuxFwP5Coreio1W<MuxSwitchClear0Spec> {
        MuxFwP5Coreio1W::new(self, 27)
    }
    #[doc = "Bit 28 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p6_coreio2(&mut self) -> MuxFwP6Coreio2W<MuxSwitchClear0Spec> {
        MuxFwP6Coreio2W::new(self, 28)
    }
    #[doc = "Bit 29 - Write '1' to clear corresponding bit in MUX_SWITCH0"]
    #[inline(always)]
    #[must_use]
    pub fn mux_fw_p7_coreio3(&mut self) -> MuxFwP7Coreio3W<MuxSwitchClear0Spec> {
        MuxFwP7Coreio3W::new(self, 29)
    }
}
#[doc = "SARMUX Firmware switch control clear\n\nYou can [`read`](crate::Reg::read) this register and get [`mux_switch_clear0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mux_switch_clear0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MuxSwitchClear0Spec;
impl crate::RegisterSpec for MuxSwitchClear0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mux_switch_clear0::R`](R) reader structure"]
impl crate::Readable for MuxSwitchClear0Spec {}
#[doc = "`write(|w| ..)` method takes [`mux_switch_clear0::W`](W) writer structure"]
impl crate::Writable for MuxSwitchClear0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MUX_SWITCH_CLEAR0 to value 0"]
impl crate::Resettable for MuxSwitchClear0Spec {
