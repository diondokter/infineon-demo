...
pub type R = crate::R<IntrSpiEcMaskSpec>;
#[doc = "Register `INTR_SPI_EC_MASK` writer"]
pub type W = crate::W<IntrSpiEcMaskSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wake_up(&mut self) -> WakeUpW<IntrSpiEcMaskSpec> {
        WakeUpW::new(self, 0)
    }
    #[doc = "Bit 1 - Mask bit for corresponding bit in interrupt request register."]
    #[inline(always)]
    #[must_use]
    pub fn ez_stop(&mut self) -> EzStopW<IntrSpiEcMaskSpec> {
        EzStopW::new(self, 1)
    }
    #[doc = "Bit 2 - Mask bit for corresponding bit in interrupt request register."]
    #[inline(always)]
    #[must_use]
    pub fn ez_write_stop(&mut self) -> EzWriteStopW<IntrSpiEcMaskSpec> {
        EzWriteStopW::new(self, 2)
    }
    #[doc = "Bit 3 - Mask bit for corresponding bit in interrupt request register."]
    #[inline(always)]
    #[must_use]
    pub fn ez_read_stop(&mut self) -> EzReadStopW<IntrSpiEcMaskSpec> {
        EzReadStopW::new(self, 3)
    }
}
#[doc = "Externally clocked SPI interrupt mask\n\nYou can [`read`](crate::Reg::read) this register and get [`intr_spi_ec_mask::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`intr_spi_ec_mask::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IntrSpiEcMaskSpec;
impl crate::RegisterSpec for IntrSpiEcMaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intr_spi_ec_mask::R`](R) reader structure"]
impl crate::Readable for IntrSpiEcMaskSpec {}
#[doc = "`write(|w| ..)` method takes [`intr_spi_ec_mask::W`](W) writer structure"]
impl crate::Writable for IntrSpiEcMaskSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets INTR_SPI_EC_MASK to value 0"]
impl crate::Resettable for IntrSpiEcMaskSpec {
