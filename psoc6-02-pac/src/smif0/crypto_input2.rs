...
pub type R = crate::R<CryptoInput2Spec>;
#[doc = "Register `CRYPTO_INPUT2` writer"]
pub type W = crate::W<CryptoInput2Spec>;
...
= CRYPTO_INPUT2.INPUT\\[31:0\\]."]
    #[inline(always)]
    #[must_use]
    pub fn input(&mut self) -> InputW<CryptoInput2Spec> {
        InputW::new(self, 0)
    }
}
#[doc = "Cryptography input 2\n\nYou can [`read`](crate::Reg::read) this register and get [`crypto_input2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`crypto_input2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CryptoInput2Spec;
impl crate::RegisterSpec for CryptoInput2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`crypto_input2::R`](R) reader structure"]
impl crate::Readable for CryptoInput2Spec {}
#[doc = "`write(|w| ..)` method takes [`crypto_input2::W`](W) writer structure"]
impl crate::Writable for CryptoInput2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CRYPTO_INPUT2 to value 0"]
impl crate::Resettable for CryptoInput2Spec {
