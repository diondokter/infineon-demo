...
pub type R = crate::R<WrModeCtlSpec>;
#[doc = "Register `WR_MODE_CTL` writer"]
pub type W = crate::W<WrModeCtlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn code(&mut self) -> CodeW<WrModeCtlSpec> {
        CodeW::new(self, 0)
    }
    #[doc = "Bits 16:17 - Width of transfer."]
    #[inline(always)]
    #[must_use]
    pub fn width(&mut self) -> WidthW<WrModeCtlSpec> {
        WidthW::new(self, 16)
    }
    #[doc = "Bit 31 - Presence of mode field: '0': not present '1': present"]
    #[inline(always)]
    #[must_use]
    pub fn present(&mut self) -> PresentW<WrModeCtlSpec> {
        PresentW::new(self, 31)
    }
}
#[doc = "Write mode control\n\nYou can [`read`](crate::Reg::read) this register and get [`wr_mode_ctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`wr_mode_ctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct WrModeCtlSpec;
impl crate::RegisterSpec for WrModeCtlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`wr_mode_ctl::R`](R) reader structure"]
impl crate::Readable for WrModeCtlSpec {}
#[doc = "`write(|w| ..)` method takes [`wr_mode_ctl::W`](W) writer structure"]
impl crate::Writable for WrModeCtlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets WR_MODE_CTL to value 0"]
impl crate::Resettable for WrModeCtlSpec {
