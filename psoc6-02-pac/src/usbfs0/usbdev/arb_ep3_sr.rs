...
pub type R = crate::R<ArbEp3SrSpec>;
#[doc = "Register `ARB_EP3_SR` writer"]
pub type W = crate::W<ArbEp3SrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn in_buf_full(&mut self) -> InBufFullW<ArbEp3SrSpec> {
        InBufFullW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint DMA Grant Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn dma_gnt(&mut self) -> DmaGntW<ArbEp3SrSpec> {
        DmaGntW::new(self, 1)
    }
    #[doc = "Bit 2 - Endpoint Buffer Overflow Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn buf_over(&mut self) -> BufOverW<ArbEp3SrSpec> {
        BufOverW::new(self, 2)
    }
    #[doc = "Bit 3 - Endpoint Buffer Underflow Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn buf_under(&mut self) -> BufUnderW<ArbEp3SrSpec> {
        BufUnderW::new(self, 3)
    }
    #[doc = "Bit 5 - Endpoint DMA Terminated Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn dma_termin(&mut self) -> DmaTerminW<ArbEp3SrSpec> {
        DmaTerminW::new(self, 5)
    }
}
#[doc = "Endpoint Interrupt Enable Register *1\n\nYou can [`read`](crate::Reg::read) this register and get [`arb_ep3_sr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`arb_ep3_sr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ArbEp3SrSpec;
impl crate::RegisterSpec for ArbEp3SrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`arb_ep3_sr::R`](R) reader structure"]
impl crate::Readable for ArbEp3SrSpec {}
#[doc = "`write(|w| ..)` method takes [`arb_ep3_sr::W`](W) writer structure"]
impl crate::Writable for ArbEp3SrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ARB_EP3_SR to value 0"]
impl crate::Resettable for ArbEp3SrSpec {
