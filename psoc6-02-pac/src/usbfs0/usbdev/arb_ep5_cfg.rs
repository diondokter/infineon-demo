...
pub type R = crate::R<ArbEp5CfgSpec>;
#[doc = "Register `ARB_EP5_CFG` writer"]
pub type W = crate::W<ArbEp5CfgSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn in_data_rdy(&mut self) -> InDataRdyW<ArbEp5CfgSpec> {
        InDataRdyW::new(self, 0)
    }
    #[doc = "Bit 1 - Manual DMA Request for a particular (1 to 8) endpoint; changing this field from 0 to 1 causes a DMA request to be generated."]
    #[inline(always)]
    #[must_use]
    pub fn dma_req(&mut self) -> DmaReqW<ArbEp5CfgSpec> {
        DmaReqW::new(self, 1)
    }
    #[doc = "Bit 2 - Configuration Setting to prevent CRC bytes from being written to memory and being read by firmware"]
    #[inline(always)]
    #[must_use]
    pub fn crc_bypass(&mut self) -> CrcBypassW<ArbEp5CfgSpec> {
        CrcBypassW::new(self, 2)
    }
    #[doc = "Bit 3 - Configuration Setting to Reset the RA and WA Pointers to their start values at the End of Packet transaction."]
    #[inline(always)]
    #[must_use]
    pub fn reset_ptr(&mut self) -> ResetPtrW<ArbEp5CfgSpec> {
        ResetPtrW::new(self, 3)
    }
}
#[doc = "Endpoint Configuration Register *1\n\nYou can [`read`](crate::Reg::read) this register and get [`arb_ep5_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`arb_ep5_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ArbEp5CfgSpec;
impl crate::RegisterSpec for ArbEp5CfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`arb_ep5_cfg::R`](R) reader structure"]
impl crate::Readable for ArbEp5CfgSpec {}
#[doc = "`write(|w| ..)` method takes [`arb_ep5_cfg::W`](W) writer structure"]
impl crate::Writable for ArbEp5CfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ARB_EP5_CFG to value 0"]
impl crate::Resettable for ArbEp5CfgSpec {
