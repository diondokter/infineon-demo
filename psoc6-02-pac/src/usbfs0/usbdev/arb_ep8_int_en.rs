...
pub type R = crate::R<ArbEp8IntEnSpec>;
#[doc = "Register `ARB_EP8_INT_EN` writer"]
pub type W = crate::W<ArbEp8IntEnSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn in_buf_full_en(&mut self) -> InBufFullEnW<ArbEp8IntEnSpec> {
        InBufFullEnW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint DMA Grant Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dma_gnt_en(&mut self) -> DmaGntEnW<ArbEp8IntEnSpec> {
        DmaGntEnW::new(self, 1)
    }
    #[doc = "Bit 2 - Endpoint Buffer Overflow Enable"]
    #[inline(always)]
    #[must_use]
    pub fn buf_over_en(&mut self) -> BufOverEnW<ArbEp8IntEnSpec> {
        BufOverEnW::new(self, 2)
    }
    #[doc = "Bit 3 - Endpoint Buffer Underflow Enable"]
    #[inline(always)]
    #[must_use]
    pub fn buf_under_en(&mut self) -> BufUnderEnW<ArbEp8IntEnSpec> {
        BufUnderEnW::new(self, 3)
    }
    #[doc = "Bit 4 - Endpoint Error in Transaction Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn err_int_en(&mut self) -> ErrIntEnW<ArbEp8IntEnSpec> {
        ErrIntEnW::new(self, 4)
    }
    #[doc = "Bit 5 - Endpoint DMA Terminated Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dma_termin_en(&mut self) -> DmaTerminEnW<ArbEp8IntEnSpec> {
        DmaTerminEnW::new(self, 5)
    }
}
#[doc = "Endpoint Interrupt Enable Register *1\n\nYou can [`read`](crate::Reg::read) this register and get [`arb_ep8_int_en::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`arb_ep8_int_en::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ArbEp8IntEnSpec;
impl crate::RegisterSpec for ArbEp8IntEnSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`arb_ep8_int_en::R`](R) reader structure"]
impl crate::Readable for ArbEp8IntEnSpec {}
#[doc = "`write(|w| ..)` method takes [`arb_ep8_int_en::W`](W) writer structure"]
impl crate::Writable for ArbEp8IntEnSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ARB_EP8_INT_EN to value 0"]
impl crate::Resettable for ArbEp8IntEnSpec {
