...
pub type R = crate::R<ArbRw3RaMsbSpec>;
#[doc = "Register `ARB_RW3_RA_MSB` writer"]
pub type W = crate::W<ArbRw3RaMsbSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ra_msb(&mut self) -> RaMsbW<ArbRw3RaMsbSpec> {
        RaMsbW::new(self, 0)
    }
}
#[doc = "Endpoint Read Address value *1, *2\n\nYou can [`read`](crate::Reg::read) this register and get [`arb_rw3_ra_msb::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`arb_rw3_ra_msb::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ArbRw3RaMsbSpec;
impl crate::RegisterSpec for ArbRw3RaMsbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`arb_rw3_ra_msb::R`](R) reader structure"]
impl crate::Readable for ArbRw3RaMsbSpec {}
#[doc = "`write(|w| ..)` method takes [`arb_rw3_ra_msb::W`](W) writer structure"]
impl crate::Writable for ArbRw3RaMsbSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ARB_RW3_RA_MSB to value 0"]
impl crate::Resettable for ArbRw3RaMsbSpec {
