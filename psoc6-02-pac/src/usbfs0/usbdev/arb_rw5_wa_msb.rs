...
pub type R = crate::R<ArbRw5WaMsbSpec>;
#[doc = "Register `ARB_RW5_WA_MSB` writer"]
pub type W = crate::W<ArbRw5WaMsbSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wa_msb(&mut self) -> WaMsbW<ArbRw5WaMsbSpec> {
        WaMsbW::new(self, 0)
    }
}
#[doc = "Endpoint Write Address value *1, *2\n\nYou can [`read`](crate::Reg::read) this register and get [`arb_rw5_wa_msb::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`arb_rw5_wa_msb::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ArbRw5WaMsbSpec;
impl crate::RegisterSpec for ArbRw5WaMsbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`arb_rw5_wa_msb::R`](R) reader structure"]
impl crate::Readable for ArbRw5WaMsbSpec {}
#[doc = "`write(|w| ..)` method takes [`arb_rw5_wa_msb::W`](W) writer structure"]
impl crate::Writable for ArbRw5WaMsbSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ARB_RW5_WA_MSB to value 0"]
impl crate::Resettable for ArbRw5WaMsbSpec {
