...
pub type R = crate::R<SieEp1Cnt1Spec>;
#[doc = "Register `SIE_EP1_CNT1` writer"]
pub type W = crate::W<SieEp1Cnt1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data_count(&mut self) -> DataCountW<SieEp1Cnt1Spec> {
        DataCountW::new(self, 0)
    }
}
#[doc = "Non-control endpoint count register\n\nYou can [`read`](crate::Reg::read) this register and get [`sie_ep1_cnt1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sie_ep1_cnt1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SieEp1Cnt1Spec;
impl crate::RegisterSpec for SieEp1Cnt1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sie_ep1_cnt1::R`](R) reader structure"]
impl crate::Readable for SieEp1Cnt1Spec {}
#[doc = "`write(|w| ..)` method takes [`sie_ep1_cnt1::W`](W) writer structure"]
impl crate::Writable for SieEp1Cnt1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SIE_EP1_CNT1 to value 0"]
impl crate::Resettable for SieEp1Cnt1Spec {
