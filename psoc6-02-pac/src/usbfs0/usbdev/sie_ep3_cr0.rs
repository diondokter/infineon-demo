...
pub type R = crate::R<SieEp3Cr0Spec>;
#[doc = "Register `SIE_EP3_CR0` writer"]
pub type W = crate::W<SieEp3Cr0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mode(&mut self) -> ModeW<SieEp3Cr0Spec> {
        ModeW::new(self, 0)
    }
    #[doc = "Bit 4 - The ACK'd transaction bit is set whenever the SIE engages in a transaction to the register's endpoint that completes with an ACK packet. This bit is cleared by any writes to the register."]
    #[inline(always)]
    #[must_use]
    pub fn acked_txn(&mut self) -> AckedTxnW<SieEp3Cr0Spec> {
        AckedTxnW::new(self, 4)
    }
    #[doc = "Bit 5 - When set this bit causes an endpoint interrupt to be generated even when a transfer completes with a NAK."]
    #[inline(always)]
    #[must_use]
    pub fn nak_int_en(&mut self) -> NakIntEnW<SieEp3Cr0Spec> {
        NakIntEnW::new(self, 5)
    }
    #[doc = "Bit 6 - The Error in transaction bit is set whenever an error is detected. For an IN transaction, this indicates a no response from HOST scenario. For an OUT transaction, this represents an RxErr (PID error/ CRC error/ bit-stuff error scenario). This bit is cleared by any writes to the register."]
    #[inline(always)]
    #[must_use]
    pub fn err_in_txn(&mut self) -> ErrInTxnW<SieEp3Cr0Spec> {
        ErrInTxnW::new(self, 6)
    }
    #[doc = "Bit 7 - When this bit is set the SIE stalls an OUT packet if the Mode bits are set to ACK-OUT. The SIE stalls an IN packet if the mode bits are set to ACK-IN. This bit must be clear for all other modes."]
    #[inline(always)]
    #[must_use]
    pub fn stall(&mut self) -> StallW<SieEp3Cr0Spec> {
        StallW::new(self, 7)
    }
}
#[doc = "Non-control endpoint's control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`sie_ep3_cr0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sie_ep3_cr0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SieEp3Cr0Spec;
impl crate::RegisterSpec for SieEp3Cr0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sie_ep3_cr0::R`](R) reader structure"]
impl crate::Readable for SieEp3Cr0Spec {}
#[doc = "`write(|w| ..)` method takes [`sie_ep3_cr0::W`](W) writer structure"]
impl crate::Writable for SieEp3Cr0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SIE_EP3_CR0 to value 0"]
impl crate::Resettable for SieEp3Cr0Spec {
