...
pub type R = crate::R<SieEp7Cnt0Spec>;
#[doc = "Register `SIE_EP7_CNT0` writer"]
pub type W = crate::W<SieEp7Cnt0Spec>;
...
bits of the CNT1 register. Refer to the CNT1 register for more information."]
    #[inline(always)]
    #[must_use]
    pub fn data_count_msb(&mut self) -> DataCountMsbW<SieEp7Cnt0Spec> {
        DataCountMsbW::new(self, 0)
    }
    #[doc = "Bit 6 - This bit is used for OUT transactions only and is read only. It is cleared to '0' if CRC bit stuffing errors or PID errors occur. This bit does not update for some endpoint mode settings."]
    #[inline(always)]
    #[must_use]
    pub fn data_valid(&mut self) -> DataValidW<SieEp7Cnt0Spec> {
        DataValidW::new(self, 6)
    }
    #[doc = "Bit 7 - This bit selects the DATA packet's toggle state. For IN transactions firmware must set this bit to the expected state. For OUT transactions the hardware sets this bit to the state of the received Data Toggle bit."]
    #[inline(always)]
    #[must_use]
    pub fn data_toggle(&mut self) -> DataToggleW<SieEp7Cnt0Spec> {
        DataToggleW::new(self, 7)
    }
}
#[doc = "Non-control endpoint count register\n\nYou can [`read`](crate::Reg::read) this register and get [`sie_ep7_cnt0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sie_ep7_cnt0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SieEp7Cnt0Spec;
impl crate::RegisterSpec for SieEp7Cnt0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sie_ep7_cnt0::R`](R) reader structure"]
impl crate::Readable for SieEp7Cnt0Spec {}
#[doc = "`write(|w| ..)` method takes [`sie_ep7_cnt0::W`](W) writer structure"]
impl crate::Writable for SieEp7Cnt0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SIE_EP7_CNT0 to value 0"]
impl crate::Resettable for SieEp7Cnt0Spec {
