...
pub type R = crate::R<SieEpIntEnSpec>;
#[doc = "Register `SIE_EP_INT_EN` writer"]
pub type W = crate::W<SieEpIntEnSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ep1_intr_en(&mut self) -> Ep1IntrEnW<SieEpIntEnSpec> {
        Ep1IntrEnW::new(self, 0)
    }
    #[doc = "Bit 1 - Enables interrupt for EP2"]
    #[inline(always)]
    #[must_use]
    pub fn ep2_intr_en(&mut self) -> Ep2IntrEnW<SieEpIntEnSpec> {
        Ep2IntrEnW::new(self, 1)
    }
    #[doc = "Bit 2 - Enables interrupt for EP3"]
    #[inline(always)]
    #[must_use]
    pub fn ep3_intr_en(&mut self) -> Ep3IntrEnW<SieEpIntEnSpec> {
        Ep3IntrEnW::new(self, 2)
    }
    #[doc = "Bit 3 - Enables interrupt for EP4"]
    #[inline(always)]
    #[must_use]
    pub fn ep4_intr_en(&mut self) -> Ep4IntrEnW<SieEpIntEnSpec> {
        Ep4IntrEnW::new(self, 3)
    }
    #[doc = "Bit 4 - Enables interrupt for EP5"]
    #[inline(always)]
    #[must_use]
    pub fn ep5_intr_en(&mut self) -> Ep5IntrEnW<SieEpIntEnSpec> {
        Ep5IntrEnW::new(self, 4)
    }
    #[doc = "Bit 5 - Enables interrupt for EP6"]
    #[inline(always)]
    #[must_use]
    pub fn ep6_intr_en(&mut self) -> Ep6IntrEnW<SieEpIntEnSpec> {
        Ep6IntrEnW::new(self, 5)
    }
    #[doc = "Bit 6 - Enables interrupt for EP7"]
    #[inline(always)]
    #[must_use]
    pub fn ep7_intr_en(&mut self) -> Ep7IntrEnW<SieEpIntEnSpec> {
        Ep7IntrEnW::new(self, 6)
    }
    #[doc = "Bit 7 - Enables interrupt for EP8"]
    #[inline(always)]
    #[must_use]
    pub fn ep8_intr_en(&mut self) -> Ep8IntrEnW<SieEpIntEnSpec> {
        Ep8IntrEnW::new(self, 7)
    }
}
#[doc = "USB SIE Data Endpoints Interrupt Enable Register\n\nYou can [`read`](crate::Reg::read) this register and get [`sie_ep_int_en::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sie_ep_int_en::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SieEpIntEnSpec;
impl crate::RegisterSpec for SieEpIntEnSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sie_ep_int_en::R`](R) reader structure"]
impl crate::Readable for SieEpIntEnSpec {}
#[doc = "`write(|w| ..)` method takes [`sie_ep_int_en::W`](W) writer structure"]
impl crate::Writable for SieEpIntEnSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SIE_EP_INT_EN to value 0"]
impl crate::Resettable for SieEpIntEnSpec {
