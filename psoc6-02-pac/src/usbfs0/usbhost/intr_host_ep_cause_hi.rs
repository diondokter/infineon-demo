...
pub type R = crate::R<IntrHostEpCauseHiSpec>;
...
#[doc = "Interrupt USB Host Endpoint Cause High Register\n\nYou can [`read`](crate::Reg::read) this register and get [`intr_host_ep_cause_hi::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IntrHostEpCauseHiSpec;
impl crate::RegisterSpec for IntrHostEpCauseHiSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intr_host_ep_cause_hi::R`](R) reader structure"]
impl crate::Readable for IntrHostEpCauseHiSpec {}
#[doc = "`reset()` method sets INTR_HOST_EP_CAUSE_HI to value 0"]
impl crate::Resettable for IntrHostEpCauseHiSpec {
