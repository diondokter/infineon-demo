...
pub type R = crate::R<IntrHostEpCauseMedSpec>;
...
#[doc = "Interrupt USB Host Endpoint Cause Medium Register\n\nYou can [`read`](crate::Reg::read) this register and get [`intr_host_ep_cause_med::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IntrHostEpCauseMedSpec;
impl crate::RegisterSpec for IntrHostEpCauseMedSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intr_host_ep_cause_med::R`](R) reader structure"]
impl crate::Readable for IntrHostEpCauseMedSpec {}
#[doc = "`reset()` method sets INTR_HOST_EP_CAUSE_MED to value 0"]
impl crate::Resettable for IntrHostEpCauseMedSpec {
