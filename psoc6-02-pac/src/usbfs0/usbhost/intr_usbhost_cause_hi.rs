...
pub type R = crate::R<IntrUsbhostCauseHiSpec>;
...
#[doc = "Interrupt USB Host Cause High Register\n\nYou can [`read`](crate::Reg::read) this register and get [`intr_usbhost_cause_hi::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IntrUsbhostCauseHiSpec;
impl crate::RegisterSpec for IntrUsbhostCauseHiSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intr_usbhost_cause_hi::R`](R) reader structure"]
impl crate::Readable for IntrUsbhostCauseHiSpec {}
#[doc = "`reset()` method sets INTR_USBHOST_CAUSE_HI to value 0"]
impl crate::Resettable for IntrUsbhostCauseHiSpec {
