...
pub type R = crate::R<IntrUsbhostCauseMedSpec>;
...
#[doc = "Interrupt USB Host Cause Medium Register\n\nYou can [`read`](crate::Reg::read) this register and get [`intr_usbhost_cause_med::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IntrUsbhostCauseMedSpec;
impl crate::RegisterSpec for IntrUsbhostCauseMedSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intr_usbhost_cause_med::R`](R) reader structure"]
impl crate::Readable for IntrUsbhostCauseMedSpec {}
#[doc = "`reset()` method sets INTR_USBHOST_CAUSE_MED to value 0"]
impl crate::Resettable for IntrUsbhostCauseMedSpec {
