...
pub type R = crate::R<IntrCauseHiSpec>;
...
#[doc = "High priority interrupt Cause register\n\nYou can [`read`](crate::Reg::read) this register and get [`intr_cause_hi::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IntrCauseHiSpec;
impl crate::RegisterSpec for IntrCauseHiSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intr_cause_hi::R`](R) reader structure"]
impl crate::Readable for IntrCauseHiSpec {}
#[doc = "`reset()` method sets INTR_CAUSE_HI to value 0"]
impl crate::Resettable for IntrCauseHiSpec {
