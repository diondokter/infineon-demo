...
pub type R = crate::R<IntrCauseMedSpec>;
...
#[doc = "Medium priority interrupt Cause register\n\nYou can [`read`](crate::Reg::read) this register and get [`intr_cause_med::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IntrCauseMedSpec;
impl crate::RegisterSpec for IntrCauseMedSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`intr_cause_med::R`](R) reader structure"]
impl crate::Readable for IntrCauseMedSpec {}
#[doc = "`reset()` method sets INTR_CAUSE_MED to value 0"]
impl crate::Resettable for IntrCauseMedSpec {
